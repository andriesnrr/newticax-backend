...
export const env = {
  ...
  CORS_ORIGIN: process.env.CORS_ORIGIN || 'http://localhost:3000,https://newticax.vercel.app',
  ...
  RATE_LIMIT_MAX: parseInt(process.env.RATE_LIMIT_MAX || '200', 10), // Increased for production
  AUTH_RATE_LIMIT_MAX: parseInt(process.env.AUTH_RATE_LIMIT_MAX || '10', 10), // Slightly increased
...
// Validation function - Modified for Railway
